const CONFIG = { API_URL: "http://localhost:8000/api", SUPABASE_URL: "https://bxagesejrodvhlmfiunj.supabase.co", SUPABASE_ANON_KEY: "sb_publishable_VYPZoCGSUXBLmTl1jFVcYg_a3ERNCq6"};
